...
export default {
  ...
  mounted() {
    ...
    this.check(1, (res) => {
      ...
      for (var i = 0; i < res.length; i++) {
        ...
        res[i].price = new Intl.NumberFormat('ko-KR', {
          style: 'currency',
          currency: 'KRW',
        }).format(res[i].price)
        if (res[i].site == 1)
  ...
  methods: {
    ...
    check: function(count, callback) {
      ...
      data.price = [
        this.priceSlider.value[0] * 10000,
        this.priceSlider.value[1] * 10000,
      ]
      data.title = document.getElementById('searchBox').value
      data.count = count
  ...
  <Layout>
        ...
        <div class="card-box cardBox">
          ...
          <div class="row">
            ...
            <div class="col-sm-1 ">
              <input
                ...
                v-model="ramSlider.value[0]"
                @input="clearErrorMsgRam"
              />
            </div>
            <div class="col-sm-6">
              <vue-slider
          ...
          <div class="row">
            ...
            <div class="col-sm-1 ">
              <input
                class="form-control form-control-sm"
                v-model="ssdSlider.value[0]"
                @input="clearErrorMsgSSD"
              />
            </div>
            <div class="col-sm-6">
              <vue-slider
          ...
          <div class="row">
            ...
            <div class="col-sm-1 ">
              <input
                class="form-control form-control-sm"
                v-model="displaySlider.value[0]"
                @input="clearErrorMsgDisplay"
              />
            </div>
            <div class="col-sm-6">
              <vue-slider
          ...
          <div class="row">
            ...
            <div class="col-sm-1 ">
              <input
                class="form-control form-control-sm"
                v-model="priceSlider.value[0]"
                @input="clearErrorMsgPrice"
              />
            </div>
            <div class="col-sm-6">
              <vue-slider
            ...
            <div class="app-search-box">
              <div class="input-group">
                ...
                <div class="input-group-append">
                  <button class="btn btnBox" @click="load(count)">
                    <i class="fe-search searchIcon"></i>
                  </button>
                </div>
              </div>
            </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card-box cardBox">
          <!-- 상품 정보 표기 -->
          <div class="responsive-table-plugin responsiveTablePlugin">
            <div class="table-wrapper">
              <div
                class="table-rep-plugin fixed-solution"
                  ...
                  <table id="tech-companies-1" class="table table-striped mb-0">
                    <thead>
                      <tr>
                        ...
                        <th
                          id="tech-companies-1-col-1"
                          class="tableTitle"
                          data-priority="1"
                          >글 제목</th
                        >
                        <th
                          id="tech-companies-1-col-2"
                          class="tablePrice"
                          data-priority="1"
                          >가격</th
                        >
                        <th
                          id="tech-companies-1-col-3"
                          class="tableTime"
                          data-priority="1"
                          >날짜</th
                        >
                    ...
                    <tbody>
                      <tr v-for="con in contents" :key="con._id">
                        <th
                          data-org-colspan="1"
                          data-columns="tech-companies-1-col-0"
                        >
                          <a :href="con.url"
                            ><img :src="con.site"/>
                            <div class="overview">
          ...
          <button class="scrollButton" @click="scrollload"> </button>
        </div>
      </div>
    </div>
  </Layout>
