  ...
  methods: {
    ...
    check: function(callback) {
      ...
      $.ajax({
        ...
        url: "http://52.78.210.26:8080/smartphone",
        success: res => {
        ...
        <div class="page-title-box">
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item active">스마트폰</li>
            </ol>
          </div>
          <h4 class="page-title">SmartPhone</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
        ...
        <div class="card-box">
          <div class="row">
            ...
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="삼성" type="checkbox" name="company" onclick="load()" />
            ...
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="APPLE" type="checkbox" name="company" />
              <label for="company_checkbox2">Apple</label>
            </div>
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="샤오미" type="checkbox" name="company" />
              <label for="company_checkbox3">샤오미</label>
            </div>
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="화웨이" type="checkbox" name="company" />
              <label for="company_checkbox4">화웨이</label>
            </div>
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="Google" type="checkbox" name="company" />
              <label for="company_checkbox4">Google</label>
            </div>
          </div>
