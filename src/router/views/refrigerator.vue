  ...
  methods: {
    ...
    check: function(callback) {
      ...
      $.ajax({
        ...
        url: "http://52.78.210.26:8080/refrigerator",
        success: res => {
        ...
        <div class="page-title-box">
          <div class="page-title-right">
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item active">냉장고</li>
            </ol>
          </div>
          <h4 class="page-title">Refrigerator</h4>
        </div>
      </div>
    </div>
    <!-- end page title -->
      ...
      <div class="col-12">
        <div class="card-box">
          <div class="row">
            ...
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
              <input id="캐리어" type="checkbox" name="company" @click="load" />
              <label for="company_checkbox2">캐리어</label>
            </div>
            <div class="col-sm-1 checkbox checkbox-primary form-check-inline">
          ...
          <div class="row">
            ...
            <div class="col-sm-1 ">
              <input id="ignoreCapacity" type="checkbox" name="ignore" @click="load" Checked>무시</input>
            </div>
            <div class="col-sm-1 ">
              <input class="form-control form-control-sm" v-model="capacitySlider.value[0]" @input="clearErrorMsgCapacity" />
            </div>
            <div class="col-sm-6">
            <vue-slider
            ...
            <div class="col-sm-1">
              <input class="form-control form-control-sm" v-model="capacitySlider.value[1]" @input="clearErrorMsgCapacity" />
            </div>
          </div>
